...
def chrom_encoding():
    for i in range(population_size):
        ...
        while(a==0 or b==0 or c==0 or d==0 or e==0 or f==0 or g==0 or h==0 or A==0 or B==0 or C==0 or D==0 or E==0 or F==0 or G==0 or H==0):
            a = random.randint(0, 40)          #56
            b = random.randint(0, 40 - a)
            c = random.randint(0, 40 - a - b)
            d = random.randint(0, 40 - a - b - c)
            e = random.randint(0, 40 - a - b - c - d)
            f = random.randint(0, 40 - a - b - c - d - e)
            g = random.randint(0, 40 - a - b - c - d - e - f)
            h = 40 - a - b - c - d - e - f - g

            A = random.randint(0, 45)           #62
            B = random.randint(0, 45 - A)
            C = random.randint(0, 45 - A - B)
            D = random.randint(0, 45 - A - B - C)
            E = random.randint(0, 45 - A - B - C - D)
            F = random.randint(0, 45 - A - B - C - D - E)
            G = random.randint(0, 45 - A - B - C - D - E - F)
            H = 45 - A - B - C - D - E - F - G
...
for i in genetic_population:
    print("this is genetic_population:", i)
