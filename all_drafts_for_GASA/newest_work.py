...
def chrom_encoding():
    for i in range(population_size):
        ...
        '''
        while(a==0 or b==0 or c==0 or d==0 or e==0 or A==0 or B==0 or C==0 or D==0 or E==0):
...
def calculate_fitness():
    ...
    for i in range(population_size):
        ...
        if S11 < -15 and S22 < -15 and 1 < function_value < 15:
...
def mutation():
    ...
    for i in range(population_size):
        ...
        if random.random() < pm:
            ...
            genetic_population[i][2] = random.randint(0,5)
            genetic_population[i][5] = random.randint(0, 5)
            genetic_population[i][8] = random.randint(0, 5)
...
plt.ylabel('增益/dB', fontproperties=my_font)
...
plt.xlabel('迭代次数', fontproperties=my_font)
plt.ylabel('平均增益/dB', fontproperties=my_font)
plt.show()
