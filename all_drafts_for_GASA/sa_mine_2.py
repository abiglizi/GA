...
x_new =[]
t = initT
x_old = [400, 850, 850, 550, 550, 950, 950, 760, 600, 200]
flag = True
x_max=[]
x_temp = []
    ...
    for i in range(iterL):
        while flag:
            ...
            for i in range(chrom_length):
                genetic_population_new.append(50 * random.randint(-3, 2))
            #for i in range(chrom_length):
        ...
        if res > 0:
            x_old = x_new
            print("x_new",x_new)
        #elif math.exp (res / t) > 0.99:#random.random():
        #    x_old = x_new
    t = t*eta


#print("最大解",x_max,"最大值",function(x_max)[0])
